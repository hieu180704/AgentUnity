...
- **Hệ thống Rule dùng chung (Rules)**:
  - An toàn Unity: `.agents/rules/unity-safety.md` (always_on).
  - Tra cứu Domain 2 tầng: `.agents/rules/knowledge-graph.md` (always_on).
  - Quy chuẩn C#: `.agents/rules/code-conventions.md` (model_decision).
  - Quản lý Doc & Worklog: `.agents/rules/doc-policy.md` (model_decision).
- **Bộ Template Code Mẫu (Recipes)**: Tra cứu tại `.agents/recipes/00-recipe-index.md`.
- **Bộ Kỹ năng mở rộng (Skills)**:
