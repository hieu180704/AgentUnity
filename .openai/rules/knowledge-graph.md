...
- **Tầng 2 (Leaf Nodes / Domain Docs):** Nằm tại `Docs/SourceOfTruth/<Domain>/` hoặc `.openai/rules/kg-<domain>.md`, chứa sơ đồ chi tiết, luồng gọi hàm (Call flow) và danh sách class cốt lõi của riêng phân hệ đó.
